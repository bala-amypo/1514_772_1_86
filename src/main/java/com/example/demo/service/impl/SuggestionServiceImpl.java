...
public class SuggestionServiceImpl implements SuggestionService { 
    ...
    public SuggestionServiceImpl(FarmService farmService, CatalogService 
catalogService, SuggestionRepository repo) { 
    ...
    public Suggestion generateSuggestion(Long farmId) { 
        ...
        List<Crop> crops = catalogService.findSuitableCrops(farm.getSoilPH(), 
farm.getWaterLevel(), farm.getSeason()); 
...
catalogService.findFertilizersForCrops(cropNames); 
        ...
        Suggestion s = Suggestion.builder() 
                ...
                .suggestedFertilizers(ferts.stream().map(Fertilizer::getName).
...
com.example.demo.exception.ResourceNotFoundException("Not found")); 
    } 
